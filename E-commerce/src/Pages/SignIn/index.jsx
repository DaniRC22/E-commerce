...
function SignIn() {
  ...
  const renderCreateUserInfo = ()=> {
    ...
    return (
      <form ref={form} className="flex flex-col rounded-lg p-6 border border-black gap-4 w-80">
        <div className="flex flex-col gap-1">
          <label htmlFor="name" className="font-light text-xl">Your name</label>
          <input type="text" 
          id="name"
          name="name"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="email"  className="font-light text-xl">Your Email</label>
        <input type="text" 
        id="email"
        name="email"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="password"  className="font-light text-xl">Your Password</label>
        <input type="text" 
        id="password"
        name="password"
